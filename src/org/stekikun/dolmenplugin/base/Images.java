...
public abstract class Images {
	 ...
	 */
	public static final String DOLMEN_PARSER = DIR + "dolmen_parser3.gif";
	...
	/**
	 * Warning sign icon overlay for decorators
	 */
	public static final String WARNING_OVERLAY = DIR + "warning_co.png";

	/**
	 * Error sign icon overlay for decorators
	 */
	public static final String ERROR_OVERLAY = DIR + "error_co.png";
}
